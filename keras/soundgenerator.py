...
class SoundGenerator:
    ...
    def generate(self, spectrograms, min_max_values, normalise):
        generated_spectrograms, latent_representations = \
            self.vae.reconstruct(spectrograms)
        signals = self.convert_spectrograms_to_audio(generated_spectrograms, min_max_values, normalise)
        return signals, latent_representations

    def convert_spectrograms_to_audio(self, spectrograms, min_max_values, normalise):
        signals = []
